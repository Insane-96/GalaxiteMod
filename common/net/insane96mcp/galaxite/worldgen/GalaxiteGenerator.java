...
public class GalaxiteGenerator extends WorldGenerator
{
    ...
    public GalaxiteGenerator(IBlockState state, int blockCount)
    {
        this(state, blockCount, new GalaxiteGenerator.StonePredicate());
    }

    public GalaxiteGenerator(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
